...
Для подробного синтаксиса см. [справочную документацию YQL](../reference/yql/reference/index.md).
...
### Рекомендации по времени резервного копирования
