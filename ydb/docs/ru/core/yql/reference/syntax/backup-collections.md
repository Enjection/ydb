...
Для практических примеров использования и операционного руководства см. [руководство по операциям с коллекциями резервных копий](../../reference/ydb-cli/backup-collections.md).
