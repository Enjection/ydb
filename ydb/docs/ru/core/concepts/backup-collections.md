...
- **Начать работу**: Следуйте [руководству по операциям](../operations/backup-collections.md) для пошаговых инструкций
- **Изучить команды**: Просмотрите [справочник по синтаксису YQL](../yql/reference/backup-collections.md) для полной документации команд
...
- [YQL команды резервного копирования](../yql/reference/backup-collections.md) - Полный справочник синтаксиса SQL
- [Руководство по операциям](../operations/backup-collections.md) - Практические инструкции и примеры
