...
В настоящее время внешнее хранилище требует ручных операций экспорта/импорта. Используйте [операции экспорта/импорта](../reference/ydb-cli/export-import/index.md) для перемещения резервных копий в системы внешнего хранения.
