...
public:
    ...
    // DataShard response handling
    NTabletFlatExecutor::ITransaction* CreateTxIncrementalRestoreShardResponse(TEvDataShard::TEvIncrementalRestoreResponse::TPtr& ev);
